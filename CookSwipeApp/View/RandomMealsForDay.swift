        ...
        VStack {
            ...
            VStack(alignment: .center, spacing: 10) {
                ...
                Text(random.description)
                    ...
                    .lineLimit(nil)
                // Ripennes
                Text(random.randoms.uppercased())
...
struct RandomMealsForDay_Previews: PreviewProvider {
    static var previews: some View {
        RandomMealsForDay(random: randomData[1])
    }
}
